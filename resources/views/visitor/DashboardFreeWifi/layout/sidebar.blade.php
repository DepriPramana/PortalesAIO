    ...
    <aside>
        ...
        <div class="sidebar left" style="height: 100%; position:fixed; padding-top: 2%;">
            ...
            <ul class="list-sidebar bg-defoult">
                ...
                <li> <a href="#"><i class="fa fa-laptop"></i> <span class="nav-label">Encuestas</span></a> </li>
                <li> <a href="#" data-toggle="collapse" data-target="#tables" class="collapsed active" ><i class="fa fa-table"></i> <span class="nav-label">Scopes</span><span class="fa fa-chevron-left pull-right"></span></a>
                ...
                <li> <a href="#" data-toggle="collapse" data-target="#e-commerce" class="collapsed active" ><i class="fa fa-server"></i> <span class="nav-label">Dispositivos</span><span class="fa fa-chevron-left pull-right"></span></a>
