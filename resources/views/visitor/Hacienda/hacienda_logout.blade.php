...
<head>
  ...
  <body>
    ...
    <section id="wrapper" class="free_section" style="display: block;">
      <div class="login-box">
        <div class="white-box">
          ...
          <h3 class="box-title m-b-0 center-align">{{ __('hacienda_msg.title_logout')}}</h3>
          <center>
            <small>{{ __('hacienda_msg.subtitle_logout')}}</small>
          </center>
    ...
    <!-- All Jquery -->
      ...
      <script src="{{ asset('hacienda/socialite/js/script_hacienda_logout.js') }}"></script>
