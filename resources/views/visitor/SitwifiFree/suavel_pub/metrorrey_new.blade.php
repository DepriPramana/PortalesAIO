  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 mx-auto flex-column">
      ...
      <footer class="mastfoot mt-2">
        ...
        <div class="row">
          <div class="col-md-12 h-100">
            <img class="image-fluid mt-lg-1 mt-md-1 mb-lg-1 mb-md-1" style="width: 100% !important;" id="footer_img" alt="pub2">
          </div>
        </div>
        <div class="row">
          <div class="col-2"></div>
          ...
          <div class="col-4">
            <div class="row">
              <div class="col-6"style="padding-left:5px;">
                <img class="logos_extra" class="" src="{{asset('free_wifi/logo_isa.png')}}" alt="logo_isa_corporativo" width="40px" height="40px" style="">
              </div>
              <div class="col-6" style="padding-left:5px;">
                <img class="logos_extra" class="mt-2" src="{{asset('free_wifi/logo_metrorrey.png')}}" alt="logo_isa_corporativo" width="60px" height="30px" style="">
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      if (imagen == 0) {
        $('.text_cortesia').css('color', '#285BCC'); // #285BCC
        $('.text_formulario').css('color', '#285BCC');
        ...
        var order_2 = "{{asset('free_wifi/pub/test/suavel/logo.png')}}";
        var footer =  "{{asset('free_wifi/pub/test/suavel/footer.jpg')}}";
        document.getElementById("footer_img").src = footer;
