...
<html>
	...
	<body background="{{asset ('chevrolet/fondo.jpg')}}">
		<div style="text-align: center; margin-top: 10vh;">
			<video id="vid" style="width: 80vw; height: 80vh;" autoplay="true" muted="muted">
				<source src="{{asset('chevrolet/GranVerano_AveoPtvHD_10Mas_WIFI.mp4')}}" type="video/mp4" />
			</video>
		</div>
		<form id="loginform" name="loginform" method="POST" action="https://{{ isset($_GET['sip']) ? $_GET['sip'] : '' }}:9998/SubscriberPortal/hotspotlogin">
		<!-- <form id="loginform" name="loginform" method="POST" action="http://:9997/login"> -->
			<input type="hidden" id="username" name="username" value="GUEST9999" />			
