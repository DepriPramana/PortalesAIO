...
<div id="contenido">
  ...
  <div id="box_login">
    ...
    <div id="div_img_box"> 
      <img id="img_logo"   alt="logo" src="imagenes/logo.png" title="Universidad de Negocios ISEC" />
      <img id="img_antena" alt="Wifi" src="imagenes/antena_gd.png" />
    </div><!-- imagenes top-->
      ...
      <div id="form_cont">
        ...
        <div id="form_wrapper">  
          ...
          <div id="form_boton" onclick="loginSesion()">
            ...
            <div id="form_btn_img"> <img id="" src="imagenes/key.png" /> </div>
          </div><!-- boton-->
    ...
    <div id="box_ayuda">
      <div align="center"><img id="img_ayuda" alt="comentarios" src="imagenes/comments.png" />
