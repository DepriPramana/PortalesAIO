...
<head>
    ...
    <!-- Bootstrap Core CSS -->
	<link type="text/css" rel="stylesheet" href="{{asset('palace/jamaica/css/bootstrap.min.css')}}">
    ...
    <![endif]-->
	<!-- jQuery Library -->
    <script src="{{asset('palace/jamaica/js/jquery-1.11.2.min.js')}}"></script>
    <!-- Bootstrap Core JS -->
	<script src="{{asset('palace/jamaica/js/bootstrap.min.js')}}"></script>
...
<body onload="mensaje();">
	<section class="container">
	    ...
	    <section align="center">
				<img src="{{asset('palace/jamaica/images/logo4.png')}}" width="207" height="100" alt="Jamaica Logo" class="logo-img">
		...
		<section class="login-form" align="center" id="loadingsection" style="display:none" align="center">
			<form role="login" align="center">
				<img src="{{asset('palace/jamaica/images/loading.gif')}}" alt="loading" class="img-responsive" align="center" alt="loading" />
			</form>
		</section>
		<br>
